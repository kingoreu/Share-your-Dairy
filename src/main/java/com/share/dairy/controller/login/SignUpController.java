...
public class SignUpController {
    ...
    private void onNextClicked(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/login/CharacterSelect.fxml"));
        Parent CharacterSelectRoot = loader.load();

        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        stage.getScene().setRoot(CharacterSelectRoot);
    }
}
